...
export const REGIONS = {
  HI: {
    ...
    placesNote: "7-day outlook at popular stops — high / low and chance of rain. Tap a place for its daily detail, then a day for its hourly forecast.",
    places: [
  ...
  CA: {
    ...
    locations: [
      ...
      { id: "laguna-beach", name: "Laguna Beach", lat: 33.5427, lng: -117.7854, station: 9410583, buoy: "045", alertRegion: "Orange County" },
